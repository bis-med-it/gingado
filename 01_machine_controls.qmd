...
The main result is shown below, corresponding to the difference between actual and estimated value for the whole time series (from 2000). If the red line (Brazil) stays close to the other ones - placebo estimations - then one can conclude that there was no effect from this intervention.

In fact, this seems to be the case with Brazil's labour market deregulation.
