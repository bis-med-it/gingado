...
For example, the inflation cycles for the US after World War II are shown below. The shaded periods correspond to the high inflation regime.

```{python}
df_infl_country = load_inflation_cycles("US")

pivot_df = df_infl_country.pivot(index='Date', columns='Series', values='Value')
pivot_df = pivot_df['1946-01-01':]

if "Detrended" in pivot_df.columns:
    pivot_df["Detrended"] *= 100

fig, ax = plt.subplots(figsize=(14, 8))
ax.set_title("Example: US post-war inflation cycles")
