...
class TFT(BaseEstimator, RegressorMixin):
    ...
    def _build_model(self):
        ...
        # combine nonlinearly the states from the different frequencies
        state_h = keras.layers.Dense(units=d_model, activation="sigmoid")([v for v in hist_states_h.values()])
        state_c = keras.layers.Dense(units=d_model, activation="sigmoid")([v for v in hist_states_c.values()])
        ...
        latent = {
            k: keras.layers.RepeatVector(num_timesteps_transformer)(v)
